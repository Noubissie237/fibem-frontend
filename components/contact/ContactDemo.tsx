...
const icons = [
  ...
  <IconPlay key="play" className="w-6 h-6" />,
  <IconCog key="cog" className="w-6 h-6" />,
...
export function ContactDemo({ dict }: ContactDemoProps) {
  const { demo } = dict.contactPage;
  ...
  return (
    <Section background="gray">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
        {demo.items.map((item, index) => (
          <Card key={index} hover padding="md" className="text-center">
            <div className={`w-12 h-12 rounded-xl ${colors[index]} flex items-center justify-center mx-auto mb-4`}>
              {icons[index]}
            </div>
      ...
      <div className="text-center">
        <Link
          href="#demo"
          className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-brand-blue rounded-lg hover:bg-brand-blue-700 transition-colors"
        >
          {demo.cta}
        </Link>
      </div>
