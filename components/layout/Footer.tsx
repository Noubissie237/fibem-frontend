...
// --- RÉSEAUX SOCIAUX AVEC COULEURS DE MARQUE ---
const socialLinks = [
  {
    name: "Facebook",
  ...
  },
  {
    ...
    // On utilise un dégradé via un style inline pour le fond
    color: "#E4405F",
...
export function Footer({ lang = "fr" }: FooterProps) {
  ...
  return (
    <footer className="bg-brand-blue text-white pt-16 pb-8 overflow-x-hidden">
      <Container fluid className="overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12 px-6 lg:px-12">
          ...
          <div>
            ...
            {/* Navigation en boutons - adaptatif selon l'espace */}
            <div className="grid gap-2" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 120px), 1fr))' }}>
              {navigationLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="px-3 py-2 rounded-lg bg-white text-brand-blue-800 text-xs font-medium transition-colors text-center hover:bg-white/90 whitespace-nowrap overflow-hidden text-ellipsis"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2.5 text-sm">
              <div className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 shrink-0 text-brand-blue-100"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div className="flex items-center gap-2">
                <svg
                  className="w-4 h-4 shrink-0 text-brand-blue-100"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <a
                  ...
                  className="hover:text-brand-blue-100 transition-colors text-xs"
                >
                  {locations[0].email}
                </a>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-1.5 px-2.5 py-2 rounded-lg bg-white text-brand-blue-800 text-xs transition-colors hover:bg-white/90 min-w-0 flex-1 sm:flex-initial"
              >
                <svg
                  className="w-4 h-4 text-brand-blue-800 shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 px-2.5 py-2 rounded-lg bg-[#25D366] hover:bg-[#25D366]/90 text-white text-xs transition-colors min-w-0 flex-1 sm:flex-initial"
              >
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 px-2.5 py-2 rounded-lg bg-white text-xs text-brand-blue-800 transition-colors hover:bg-white/90 min-w-0 flex-1 sm:flex-initial"
              >
                <svg
                  className="w-4 h-4 text-brand-blue-800 shrink-0"
                  fill="none"
          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white text-brand-blue-800 placeholder:text-brand-blue-800 focus:outline-none focus:ring-2 focus:ring-white text-sm"
              />
              <button
                type="submit"
                className="w-full px-6 py-2 rounded-lg bg-red-500 hover:bg-red-600 text-white font-medium text-sm transition-colors"
              >
                S&apos;abonner
              </button>
            </form>
            <p className="text-xs text-brand-blue-200 mt-3">
              En cliquant, vous nous rejoindrez via la page Contact avec votre
              email pré-rempli.
            </p>
          </div>
        </div>
            ...
            <div className="mt-4 p-4 rounded-lg bg-brand-blue-800/50 border border-brand-blue-700 text-sm text-white space-y-4 animate-fade-in">
              ...
              <div>
                ...
                <p>
                  ...
                  <Link
                    href={`/${lang}/contact`}
                    className="text-brand-blue-100 hover:underline"
                  >
                    page Contact
                  </Link>
                  .
      ...
      <Container fluid>
        <div className="mt-6 pb-4 px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
          {/* Réseaux sociaux — pastilles avec couleur de marque */}
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="group relative flex items-center justify-center w-9 h-9 rounded-full transition-all duration-200 hover:scale-110 hover:shadow-lg"
                  style={{
