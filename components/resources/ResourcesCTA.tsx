...
export function ResourcesCTA({ dict, lang }: ResourcesCTAProps) {
  const { cta } = dict.resourcesPage;
    ...
    <section className="bg-gradient-to-br from-brand-blue to-brand-blue-800 py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button href={`/${lang}/inscription`} size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10">
            {cta.secondary}
          </Button>
        </div>
      </div>
