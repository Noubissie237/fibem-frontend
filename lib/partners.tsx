...
// Icons for partner types
export const partnerTypeIcons: Record<string, ReactNode> = {
  reseller: (
...
export const processStepIcons: Record<string, ReactNode> = {
  application: (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Icons for what we provide
export const provideIcons: Record<string, ReactNode> = {
  marketing: (
